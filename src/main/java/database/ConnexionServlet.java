    ...
    public void contextInitialized(ServletContextEvent event)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                cnx = DriverManager.getConnection("jdbc:mariadb://127.0.0.1:330x/nombdd","user","mdp");
                //sauvegarder la connexion dans le context
                servletContext.setAttribute("connection",cnx);
                System.out.println("Connexion opérationnelle" + "jdbc:mariadb://127.0.0.1:330x/nombdd");
            }
